import { elm, useSignal, wrap } from "@amodx/elm";
elm.css(/* css */ `
.collapsible-section {
...
>
  ...
  `);
export default wrap("div", true, ({ title }, children) => {
    const expanded = useSignal(false);
    return elm("div", "collapsible-section", elm("div", {
        className: "collapsible-section-title",
        signal: expanded(() => { }),
        onclick() {
            expanded.value = !expanded.value;
        },
    }, elm("div", "title", title), elm("div", {
