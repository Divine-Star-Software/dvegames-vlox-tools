...
export default function (graph) {
    ToolPanelViews.registerView("World Gen", (component) => {
        return frag(elm("div", {
            ...
            async onclick() {
                DivineVoxelEngineRender.instance.threads.world.runTask("start-world", ["main", 0, 0, 0]);
            },
        }, "Start World Generation")), elm("div", {
            style: {
                display: "flex",
                flexDirection: "row",
            },
            ...
            async onclick() {
                DivineVoxelEngineRender.instance.threads.world.runTask("start-world-gen", ["main", 0, 0, 0]);
            },
